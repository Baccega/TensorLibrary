...
// Checks that the dimensions of the indexes are the same for the same index
// character Cannot be done statically
void find_incongruences(const std::vector<char> &indices,
